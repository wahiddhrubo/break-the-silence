...
const useAudio = (url) => {
  ...
  const a =
    ...
    new Audio(
      "https://ipfs.io/ipfs/QmX5NMV8hh1g5EcebX1e2Y55uQnVnKPk8YzW37wpnRWfXp/media/0"
    );
  const audioRef = useRef(a);
  ...
  useEffect(() => {
    ...
    audioRef.current = new Audio(
      url && getIpfsLink(url[trackIndex].animation_url)
    );
